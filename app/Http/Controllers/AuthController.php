...
class AuthController extends Controller
{
    ...
    public function login(Request $request): JsonResponse
    {
        try {
            ...
            // Así se valida con Sanctum que el Usuario haga Login correctamente, lo que se hace es verificar que las credenciales ingresadas coincidan con 'email', 'password' del Usuario.
